...
{	
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
			...
			if(extras != null) {
				DiagnosticsUtils.calledFromCollect = true;
				...
				else if(extras.getString("action)").equals("image")) {
					DiagnosticsUtils.calledFromCollect = true;
				}
				else {
					DiagnosticsUtils.calledFromCollect = false;
				}
				//}
            ...
            */
				...
				// not called from collect
				Log.d("DEBUG Collect call", "I wasnt called from Collect!");
				settingsButton.setVisibility(View.VISIBLE);
				DiagnosticsUtils.calledFromCollect = false;
			}
    ...
    protected void onResume() throws NullPointerException {
            ...
            if(description != null)
            {
	            ...
	            {
	            	try {
						Log.d("DEBUG processed", description.getString("processed"));
